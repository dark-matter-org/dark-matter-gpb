...
public class GpbdocTemplateLoader implements DmcUncheckedOIFHandlerIF {
    ...
    public static TemplateMediator      EnumSummary       = new TemplateMediator("EnumSummary");      // Mediator for the EnumSummary template
    ...
    public static TemplateMediator      MessageSummary    = new TemplateMediator("MessageSummary");   // Mediator for the MessageSummary template
    public static TemplateMediator      ModuleTitle       = new TemplateMediator("ModuleTitle");      // Mediator for the ModuleTitle template
    ...
    public GpbdocTemplateLoader(ArrayList<String> paths) throws ResultException, DmcValueException, DmcNameClashException {
        ...
        mediators.put("EnumSummary",EnumSummary);
        mediators.put("HtmlContent",HtmlContent);
        mediators.put("HtmlHead",HtmlHead);
        mediators.put("MessageSummary",MessageSummary);
        mediators.put("ModuleTitle",ModuleTitle);
