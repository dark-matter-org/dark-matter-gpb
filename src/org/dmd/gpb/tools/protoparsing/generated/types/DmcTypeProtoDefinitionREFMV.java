...
/**
 * The DmcTypeProtoDefinitionREFMV provides storage for a multi-valued ProtoDefinitionREF
 * <P>
...
public class DmcTypeProtoDefinitionREFMV extends DmcTypeProtoDefinitionREF implements Serializable {
    
    private final static Iterator<ProtoDefinitionREF> emptyList = (new ArrayList<ProtoDefinitionREF>()).iterator();
    
    protected ArrayList<ProtoDefinitionREF> value;
    
    public DmcTypeProtoDefinitionREFMV(){
    
    }
    
    public DmcTypeProtoDefinitionREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeProtoDefinitionREFMV getNew(){
        return(new DmcTypeProtoDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ProtoDefinitionREF> cloneIt(){
        synchronized(this){
            DmcTypeProtoDefinitionREFMV rc = getNew();
    ...
    public ProtoDefinitionREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ProtoDefinitionREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ProtoDefinitionREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ProtoDefinitionREF> clone = new ArrayList<ProtoDefinitionREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<ProtoDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ProtoDefinitionREF>());
            else 
                return(new ArrayList<ProtoDefinitionREF>(value));
        }
    }
    ...
    public ProtoDefinitionREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ProtoDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ProtoDefinitionREF>(getAttributeInfo().indexSize);
