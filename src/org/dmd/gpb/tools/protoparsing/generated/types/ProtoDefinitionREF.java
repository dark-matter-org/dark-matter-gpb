...
import org.dmd.gpb.tools.protoparsing.generated.dmo.ProtoDefinitionDMO; // primitive type
...
public class ProtoDefinitionREF extends DmcNamedObjectNontransportableREF<ProtoDefinitionDMO> {
    ...
    public ProtoDefinitionREF(){
    }

    public ProtoDefinitionREF(ProtoDefinitionDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public ProtoDefinitionREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoDefinitionREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoDefinitionREF(ProtoDefinitionREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ProtoDefinitionDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public ProtoDefinitionREF cloneMe(){
