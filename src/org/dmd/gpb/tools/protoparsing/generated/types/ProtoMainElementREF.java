...
import org.dmd.gpb.tools.protoparsing.generated.dmo.ProtoMainElementDMO; // primitive type
...
public class ProtoMainElementREF extends DmcNamedObjectNontransportableREF<ProtoMainElementDMO> {
    ...
    public ProtoMainElementREF(){
    }

    public ProtoMainElementREF(ProtoMainElementDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public ProtoMainElementREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoMainElementREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoMainElementREF(ProtoMainElementREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ProtoMainElementDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public ProtoMainElementREF cloneMe(){
