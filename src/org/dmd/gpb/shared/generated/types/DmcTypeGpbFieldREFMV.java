...
/**
 * The DmcTypeGpbFieldREFMV provides storage for a multi-valued GpbFieldREF
 * <P>
...
public class DmcTypeGpbFieldREFMV extends DmcTypeGpbFieldREF implements Serializable {
    
    private final static Iterator<GpbFieldREF> emptyList = (new ArrayList<GpbFieldREF>()).iterator();
    
    protected ArrayList<GpbFieldREF> value;
    
    public DmcTypeGpbFieldREFMV(){
    
    }
    
    public DmcTypeGpbFieldREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeGpbFieldREFMV getNew(){
        return(new DmcTypeGpbFieldREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<GpbFieldREF> cloneIt(){
        synchronized(this){
            DmcTypeGpbFieldREFMV rc = getNew();
    ...
    public GpbFieldREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<GpbFieldREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<GpbFieldREF> getMV(){
        synchronized(this){
            ...
            ArrayList<GpbFieldREF> clone = new ArrayList<GpbFieldREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<GpbFieldREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<GpbFieldREF>());
            else 
                return(new ArrayList<GpbFieldREF>(value));
        }
    }
    ...
    public GpbFieldREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public GpbFieldREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<GpbFieldREF>(getAttributeInfo().indexSize);
