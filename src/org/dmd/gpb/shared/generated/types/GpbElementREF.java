...
import org.dmd.gpb.shared.generated.dmo.GpbElementDMO; // primitive type
...
public class GpbElementREF extends DmcNamedObjectNontransportableREF<GpbElementDMO> {
    ...
    public GpbElementREF(){
    }

    public GpbElementREF(GpbElementDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbElementREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbElementREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbElementREF(GpbElementREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbElementDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
