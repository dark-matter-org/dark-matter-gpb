...
import org.dmd.gpb.server.generated.dsd.GpbModuleParser;                    // Required to parse GpbModule definitions - (DSDArtifactFormatter.java:563)
import org.dmd.gpb.shared.generated.dmo.DmdgpbDMSAG;                        // To allow loading of rules from the dmdgpb schema - (DSDArtifactFormatter.java:565)
...
public class GpbModuleGenerationCoordinator {
    ...
    TreeMap<String,ConfigLocation>    loadedConfigsForGpbModule    = new TreeMap<String, ConfigLocation>();   // The names/location of the GpbModule modules that have been loaded
