...
abstract public class GpbCompositeType extends GpbCompositeTypeDMW {
     ...
     * @param genversion the generation version.
     * @return true if the element should be included in generation
     */
     ...
     */
    public boolean shouldBeIncluded(String genversion, String version, Iterator<String> skips){
    	boolean rc = true;
