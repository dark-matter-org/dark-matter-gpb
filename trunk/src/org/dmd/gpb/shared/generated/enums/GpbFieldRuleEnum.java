...
/**
 * The GpbFieldRuleEnum indicates whether a field is required, optional or
 ...
 */
public enum GpbFieldRuleEnum implements DmcEnumIF
{
    ...
    private static final Map<Integer,GpbFieldRuleEnum> lookup = new HashMap<Integer,GpbFieldRuleEnum>();

    static {
        for(GpbFieldRuleEnum s : EnumSet.allOf(GpbFieldRuleEnum.class))
            lookup.put(s.intValue(), s);
    }

    // Maps our enumeration (string) value to the enumeration value
    private static final Map<String,GpbFieldRuleEnum> lookupString = new HashMap<String, GpbFieldRuleEnum>();
     ...
     */
    private GpbFieldRuleEnum(int i, String d){
        ival = i;
        dval = d;
    }
     ...
     */
    public static GpbFieldRuleEnum get(int code) {
     ...
     */
    public static GpbFieldRuleEnum get(String str) {
