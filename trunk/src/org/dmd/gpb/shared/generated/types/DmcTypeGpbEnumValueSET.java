...
public class DmcTypeGpbEnumValueSET extends DmcTypeGpbEnumValue implements Serializable {
    
     private final static Iterator<GpbEnumValue> emptyList =  (new HashSet<GpbEnumValue>()).iterator();
    
    
    protected Set<GpbEnumValue> value;
    
    public DmcTypeGpbEnumValueSET(){
        value = null;
    }
    
    public DmcTypeGpbEnumValueSET(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<GpbEnumValue>();
        else
            value = new TreeSet<GpbEnumValue>();
    }
    
    @Override
    public DmcTypeGpbEnumValueSET getNew(){
        return(new DmcTypeGpbEnumValueSET(getAttributeInfo()));
    }
    ...
    public Iterator<GpbEnumValue> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<GpbEnumValue>(value)).iterator() );
            else
                return( (new TreeSet<GpbEnumValue>(value)).iterator() );
        }
    }
    ...
    public Set<GpbEnumValue> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<GpbEnumValue>());
                else
                    return(new HashSet<GpbEnumValue>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<GpbEnumValue>(value));
                else
                    return(new TreeSet<GpbEnumValue>(value));
            }
        }
