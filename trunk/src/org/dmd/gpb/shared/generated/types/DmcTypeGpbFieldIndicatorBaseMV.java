...
/**
 * The DmcTypeGpbFieldIndicatorBaseMV provides storage for a multi-valued GpbFieldIndicatorBase
 * <P>
...
public class DmcTypeGpbFieldIndicatorBaseMV extends DmcTypeGpbFieldIndicatorBase implements Serializable {
    
    private final static Iterator<GpbFieldIndicatorBase> emptyList = (new ArrayList<GpbFieldIndicatorBase>()).iterator();
    
    protected ArrayList<GpbFieldIndicatorBase> value;
    
    public DmcTypeGpbFieldIndicatorBaseMV(){
    
    }
    
    public DmcTypeGpbFieldIndicatorBaseMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeGpbFieldIndicatorBaseMV getNew(){
        return(new DmcTypeGpbFieldIndicatorBaseMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<GpbFieldIndicatorBase> cloneIt(){
        synchronized(this){
            DmcTypeGpbFieldIndicatorBaseMV rc = getNew();
    ...
    public GpbFieldIndicatorBase add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<GpbFieldIndicatorBase>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public GpbFieldIndicatorBase del(Object v){
        synchronized(this){
            ...
            GpbFieldIndicatorBase key = null;
    ...
    public Iterator<GpbFieldIndicatorBase> getMV(){
        synchronized(this){
            ...
            ArrayList<GpbFieldIndicatorBase> clone = new ArrayList<GpbFieldIndicatorBase>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<GpbFieldIndicatorBase> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<GpbFieldIndicatorBase>());
            else 
                return(new ArrayList<GpbFieldIndicatorBase>(value));
        }
    }
    ...
    public GpbFieldIndicatorBase getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public GpbFieldIndicatorBase setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<GpbFieldIndicatorBase>(getAttributeInfo().indexSize);
