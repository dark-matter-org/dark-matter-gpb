...
import org.dmd.gpb.shared.generated.dmo.GpbDefinitionDMO; // primitive type
...
public class GpbDefinitionREF extends DmcNamedObjectNontransportableREF<GpbDefinitionDMO> {
    ...
    public GpbDefinitionREF(){
    }

    public GpbDefinitionREF(GpbDefinitionDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbDefinitionREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbDefinitionREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbDefinitionREF(GpbDefinitionREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbDefinitionDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public GpbDefinitionREF cloneMe(){
