...
import org.dmd.gpb.shared.generated.dmo.GpbMainElementDMO; // primitive type
...
public class GpbMainElementREF extends DmcNamedObjectNontransportableREF<GpbMainElementDMO> {
    ...
    public GpbMainElementREF(){
    }

    public GpbMainElementREF(GpbMainElementDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbMainElementREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbMainElementREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbMainElementREF(GpbMainElementREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbMainElementDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public GpbMainElementREF cloneMe(){
