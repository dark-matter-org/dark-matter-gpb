...
import org.dmd.gpb.shared.generated.dmo.GpbScalarTypeDMO; // primitive type
...
public class GpbScalarTypeREF extends DmcNamedObjectNontransportableREF<GpbScalarTypeDMO> {
    ...
    public GpbScalarTypeREF(){
    }

    public GpbScalarTypeREF(GpbScalarTypeDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbScalarTypeREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbScalarTypeREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbScalarTypeREF(GpbScalarTypeREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbScalarTypeDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public GpbScalarTypeREF cloneMe(){
