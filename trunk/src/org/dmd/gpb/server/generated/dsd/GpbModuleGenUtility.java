...
import org.dmd.gpb.server.generated.dsd.GpbModuleGeneratorInterface;         // Called by the parsing coordinator as configs are read - (DSDArtifactFormatter.java:1059)
import org.dmd.gpb.server.generated.dsd.GpbModuleParsingCoordinator;         // Parses modules required for generation - (DSDArtifactFormatter.java:1058)
...
public abstract class GpbModuleGenUtility implements GpbModuleGeneratorInterface {
    ...
    public void run(String[] args) throws ResultException, DmcValueException, IOException, DmcRuleExceptionSet, DmcNameClashException, DmcValueExceptionSet {
        ...
        parser = new GpbModuleParsingCoordinator(this, withWorkspace, jars);
