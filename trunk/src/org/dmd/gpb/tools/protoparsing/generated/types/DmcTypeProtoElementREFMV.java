...
/**
 * The DmcTypeProtoElementREFMV provides storage for a multi-valued ProtoElementREF
 * <P>
...
public class DmcTypeProtoElementREFMV extends DmcTypeProtoElementREF implements Serializable {
    
    private final static Iterator<ProtoElementREF> emptyList = (new ArrayList<ProtoElementREF>()).iterator();
    
    protected ArrayList<ProtoElementREF> value;
    
    public DmcTypeProtoElementREFMV(){
    
    }
    
    public DmcTypeProtoElementREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeProtoElementREFMV getNew(){
        return(new DmcTypeProtoElementREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ProtoElementREF> cloneIt(){
        synchronized(this){
            DmcTypeProtoElementREFMV rc = getNew();
    ...
    public ProtoElementREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ProtoElementREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ProtoElementREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ProtoElementREF> clone = new ArrayList<ProtoElementREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<ProtoElementREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ProtoElementREF>());
            else 
                return(new ArrayList<ProtoElementREF>(value));
        }
    }
    ...
    public ProtoElementREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ProtoElementREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ProtoElementREF>(getAttributeInfo().indexSize);
