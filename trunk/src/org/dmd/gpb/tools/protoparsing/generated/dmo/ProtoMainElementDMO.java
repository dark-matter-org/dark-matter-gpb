...
abstract public class ProtoMainElementDMO  extends ProtoElementDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "ProtoMainElement";


    static {
    }

    public ProtoMainElementDMO() {
        super("ProtoMainElement");
    }

    protected ProtoMainElementDMO(String oc) {
        super(oc);
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof ProtoMainElementDMO){
            return( getObjectName().equals( ((ProtoMainElementDMO) obj).getObjectName()) );
        }
        return(false);
    }
