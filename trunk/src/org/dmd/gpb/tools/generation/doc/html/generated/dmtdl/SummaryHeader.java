...
public class SummaryHeader implements SectionIF {
    ...
    /**
     * Constructs a new SummaryHeader section.
     * @param summaryTitle_ The items being summarized
     * Generated from: org.dmd.templates.server.extended.Section.generateSectionClass(Section.java:143)
     */
    public SummaryHeader(String summaryTitle_){
        if (summaryTitle_ != null)
            values.put("summaryTitle", summaryTitle_);

    }

    public SummaryHeader setSummaryTitle(String summaryTitle_){
        if (summaryTitle_ != null)
            values.put("summaryTitle", summaryTitle_);
        return(this);
    }
    ...
    public void format(FormattedArtifactIF artifact) throws IOException {
        ...
        GpbdocTemplateLoader.SummaryHeader.format(this,artifact, GpbdocTemplateLoader._Comment);
