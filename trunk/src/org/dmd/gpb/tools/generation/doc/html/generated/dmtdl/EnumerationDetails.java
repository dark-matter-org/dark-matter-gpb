...
import org.dmd.gpb.tools.generation.doc.html.generated.dmtdl.EnumerationFooter;         // Ends with one of these - (Section.java:83)
import org.dmd.gpb.tools.generation.doc.html.generated.dmtdl.EnumerationHeader;         // Starts with one of these - (Section.java:50)
...
public class EnumerationDetails implements SectionIF {
    ...
    EnumerationHeader              _EnumerationHeader;                                          // Starts with a EnumerationHeader
    ArrayList<EnumerationValue>    _EnumerationValue     = new ArrayList<EnumerationValue>();   // Multiple instances of EnumerationValue
    EnumerationFooter              _EnumerationFooter;                                          // Ends with a EnumerationFooter


    public EnumerationDetails(){
        _EnumerationHeader = new EnumerationHeader(); // Starts with
        _EnumerationFooter = new EnumerationFooter(); // Ends with
    }
    ...
    public void format(FormattedArtifactIF artifact) throws IOException {
        _EnumerationHeader.format(artifact);
        ...
        _EnumerationFooter.format(artifact);
    }
    ...
    public EnumerationHeader getEnumerationHeader(){
        return(_EnumerationHeader);
    }
    ...
    public EnumerationFooter getEnumerationFooter(){
        return(_EnumerationFooter);
    }
