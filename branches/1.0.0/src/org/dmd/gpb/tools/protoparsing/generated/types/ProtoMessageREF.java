...
import org.dmd.gpb.tools.protoparsing.generated.dmo.ProtoMessageDMO; // primitive type
...
public class ProtoMessageREF extends DmcNamedObjectNontransportableREF<ProtoMessageDMO> {
    ...
    public ProtoMessageREF(){
    }

    public ProtoMessageREF(ProtoMessageDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public ProtoMessageREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoMessageREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoMessageREF(ProtoMessageREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ProtoMessageDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public ProtoMessageREF cloneMe(){
