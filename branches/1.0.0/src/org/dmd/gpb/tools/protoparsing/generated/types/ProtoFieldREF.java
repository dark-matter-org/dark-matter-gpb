...
import org.dmd.gpb.tools.protoparsing.generated.dmo.ProtoFieldDMO; // primitive type
...
public class ProtoFieldREF extends DmcNamedObjectNontransportableREF<ProtoFieldDMO> {
    ...
    public ProtoFieldREF(){
    }

    public ProtoFieldREF(ProtoFieldDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public ProtoFieldREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoFieldREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoFieldREF(ProtoFieldREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ProtoFieldDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
