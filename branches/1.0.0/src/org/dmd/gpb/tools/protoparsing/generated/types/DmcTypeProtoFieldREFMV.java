...
/**
 * The DmcTypeProtoFieldREFMV provides storage for a multi-valued ProtoFieldREF
 * <P>
...
public class DmcTypeProtoFieldREFMV extends DmcTypeProtoFieldREF implements Serializable {
    
    private final static Iterator<ProtoFieldREF> emptyList = (new ArrayList<ProtoFieldREF>()).iterator();
    
    protected ArrayList<ProtoFieldREF> value;
    
    public DmcTypeProtoFieldREFMV(){
    
    }
    
    public DmcTypeProtoFieldREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeProtoFieldREFMV getNew(){
        return(new DmcTypeProtoFieldREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ProtoFieldREF> cloneIt(){
        synchronized(this){
            DmcTypeProtoFieldREFMV rc = getNew();
    ...
    public ProtoFieldREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ProtoFieldREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ProtoFieldREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ProtoFieldREF> clone = new ArrayList<ProtoFieldREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2452)
    public ArrayList<ProtoFieldREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ProtoFieldREF>());
            else 
                return(new ArrayList<ProtoFieldREF>(value));
        }
    }
    ...
    public ProtoFieldREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ProtoFieldREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ProtoFieldREF>(getAttributeInfo().indexSize);
