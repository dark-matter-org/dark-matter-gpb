...
import org.dmd.gpb.tools.protoparsing.generated.dmo.ProtoEnumDMO; // primitive type
...
public class ProtoEnumREF extends DmcNamedObjectNontransportableREF<ProtoEnumDMO> {
    ...
    public ProtoEnumREF(ProtoEnumDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public ProtoEnumREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoEnumREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoEnumREF(ProtoEnumREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ProtoEnumDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
