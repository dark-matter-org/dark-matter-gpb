...
import org.dmd.gpb.shared.generated.dmo.GpbModuleDMO; // primitive type
...
public class GpbModuleREF extends DmcNamedObjectNontransportableREF<GpbModuleDMO> {
    ...
    public GpbModuleREF(GpbModuleDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbModuleREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbModuleREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbModuleREF(GpbModuleREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbModuleDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
