...
import org.dmd.gpb.shared.generated.dmo.GpbCompositeTypeDMO; // primitive type
...
public class GpbCompositeTypeREF extends DmcNamedObjectNontransportableREF<GpbCompositeTypeDMO> {
    ...
    public GpbCompositeTypeREF(){
    }

    public GpbCompositeTypeREF(GpbCompositeTypeDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbCompositeTypeREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbCompositeTypeREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbCompositeTypeREF(GpbCompositeTypeREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbCompositeTypeDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public GpbCompositeTypeREF cloneMe(){
