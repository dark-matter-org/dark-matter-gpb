...
import org.dmd.gpb.shared.generated.dmo.GpbTypeDMO; // primitive type
...
public class GpbTypeREF extends DmcNamedObjectNontransportableREF<GpbTypeDMO> {
    ...
    public GpbTypeREF(GpbTypeDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbTypeREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbTypeREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbTypeREF(GpbTypeREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbTypeDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
