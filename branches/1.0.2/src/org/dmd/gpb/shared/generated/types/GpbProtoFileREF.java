...
import org.dmd.gpb.shared.generated.dmo.GpbProtoFileDMO; // primitive type
...
public class GpbProtoFileREF extends DmcNamedObjectNontransportableREF<GpbProtoFileDMO> {
    ...
    public GpbProtoFileREF(){
    }

    public GpbProtoFileREF(GpbProtoFileDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public GpbProtoFileREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbProtoFileREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public GpbProtoFileREF(GpbProtoFileREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(GpbProtoFileDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public GpbProtoFileREF cloneMe(){
