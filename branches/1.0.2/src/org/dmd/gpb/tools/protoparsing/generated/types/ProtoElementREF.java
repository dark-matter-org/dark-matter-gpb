...
import org.dmd.gpb.tools.protoparsing.generated.dmo.ProtoElementDMO; // primitive type
...
public class ProtoElementREF extends DmcNamedObjectNontransportableREF<ProtoElementDMO> {
    ...
    public ProtoElementREF(){
    }

    public ProtoElementREF(ProtoElementDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public ProtoElementREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoElementREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ProtoElementREF(ProtoElementREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ProtoElementDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public ProtoElementREF cloneMe(){
