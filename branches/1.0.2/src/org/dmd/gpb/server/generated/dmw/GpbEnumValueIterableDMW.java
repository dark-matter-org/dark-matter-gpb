...
import org.dmd.gpb.shared.generated.types.GpbEnumValue;         // This is the type we're iterating - (GenUtility.java:1742)


/**
 * The GpbEnumValueIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class GpbEnumValueIterableDMW extends DmwMVIterator<GpbEnumValue> {

    public final static GpbEnumValueIterableDMW emptyList = new GpbEnumValueIterableDMW();

    protected GpbEnumValueIterableDMW(){
        super();
    }

    public GpbEnumValueIterableDMW(Iterator<GpbEnumValue> it){
        super(it);
    }
